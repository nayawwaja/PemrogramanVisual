...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' txtNilai
        ' 
        txtNilai.Location = New Point(425, 414)
        txtNilai.Name = "txtNilai"
        txtNilai.Size = New Size(200, 39)
        txtNilai.TabIndex = 0
        ' 
        ' btnInput
        ' 
        btnInput.Location = New Point(448, 502)
        btnInput.Name = "btnInput"
        btnInput.Size = New Size(150, 46)
        btnInput.TabIndex = 1
        btnInput.Text = "Input"
        ...
        ' picImage
        ' 
        picImage.Location = New Point(448, 201)
